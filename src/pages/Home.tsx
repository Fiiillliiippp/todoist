...
const Home = () => {
  ...
  return (
    <div>
      ...
      {addingList && (
        <Box
        sx={{border: "1px solid black", borderRadius: 2 ,width: 250, justifyContent: "center", margin: "auto", marginTop: 2}}>
        <Input
        sx={{margin: 1}}
          type='textarea'
        ...
        <Button variant="text" onClick={() => setAddingList(false)}>Cancel</Button>
      </Box>
      )}
    </div>
  );
